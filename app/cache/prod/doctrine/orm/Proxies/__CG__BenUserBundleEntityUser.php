...
class User extends \Ben\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function groupAdd(\Ben\UserBundle\Entity\Group $group)
    {
        $this->__load();
        return parent::groupAdd($group);
    }

    public function groupRemove(\Ben\UserBundle\Entity\Group $group)
    {
        $this->__load();
        return parent::groupRemove($group);
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'created', 'lastActivity', 'profile', 'groups', 'cotisations', 'avancements');
    }
